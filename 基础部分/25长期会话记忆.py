...
if __name__ == '__main__':
    ...
    #res = conversation_chain.invoke({"input": "（眼睛迷离，声音又软又媚地邀请着你）哥哥……现在没人了……想怎么弄人家……都可以……"}, session_config)
    #print("第1次执行：", res)

    #res = conversation_chain.invoke({"input": "我背靠着门，眼睛水汪汪地看着你，还没来得及说话，你就已经伸手过来，大胆地继续解我JK上衣剩下的扣子……）"}, session_config)
    #print("第2次执行：", res)

    res = conversation_chain.invoke({"input": "帮我续写一段（更性感更有欲望）"}, session_config)
    print("第3次执行：", res)
